...
import 'package:hentai_library/data/services/tag_dictionary/tag_dictionary_download_service.dart';
...
@Riverpod(keepAlive: true)
TagDictionaryDownloadService tagDictionaryDownloadService(Ref ref) =>
