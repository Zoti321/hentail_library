...
import 'package:hentai_library/data/adapters/comic_page_source_adapter.dart';
import 'package:hentai_library/data/adapters/reader_session_adapter.dart';
...
@Riverpod(keepAlive: true)
ReaderSessionPort readerSessionPort(Ref ref) => ReaderSessionAdapter(
  readResourceGetService: ref.read(readResourceGetServiceProvider),
);

@Riverpod(keepAlive: true)
ComicPageSourcePort comicPageSourcePort(Ref ref) => ComicPageSourceAdapter(
  readResourceGetService: ref.read(readResourceGetServiceProvider),
);
