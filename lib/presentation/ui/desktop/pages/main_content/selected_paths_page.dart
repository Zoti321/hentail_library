...
class _SelectedPathsAsyncBody extends ConsumerWidget {
  const _SelectedPathsAsyncBody();
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return asyncState.when(
      ...
      error: (Object error, StackTrace _) => _ErrorCard(error: error),
    );
  }
}
...
class _SelectedPathsCard extends ConsumerWidget {
  const _SelectedPathsCard();
