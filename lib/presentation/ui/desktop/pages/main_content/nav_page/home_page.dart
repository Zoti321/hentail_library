...
const int _kContinueReadingVisibleCount = 10;
...
class HomePage extends ConsumerWidget {
  ...
  Widget _buildStatsCards(BuildContext context, WidgetRef ref, int comicCount) {
    ...
    final int historyCount = merged.length;
  ...
  Widget _buildContinueReadingSection(BuildContext context, WidgetRef ref) {
    ...
    final AppThemeTokens tokens = context.tokens;
    final ColorScheme cs = theme.colorScheme;
    final AsyncValue<List<ReadingHistory>> comicsAsync = ref.watch(
      readingHistoryStreamProvider,
    );
    final AsyncValue<List<SeriesReadingHistory>> seriesAsync = ref.watch(
      seriesReadingHistoryStreamProvider,
    );
    ...
    final List<HistoryGridItemDto> visible = merged
        .take(_kContinueReadingVisibleCount)
            ...
            comic: (ComicHistoryGridItemDto c) => ReadingHistoryCard.comic(
              ...
              onTap: () => appRouter.pushNamed(
                ...
                queryParameters: <String, String>{
                  ReaderRouteArgs.readTypeKey: ReaderRouteArgs.readTypeComic,
                  ReaderRouteArgs.comicIdKey: c.comicId,
                },
              ),
            ),
