...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -231530432;
...
fn wire__crate__api__reader__clear_reader_page_cache_frb_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, crate::api::init::HentaiErrorDto>((move || {
                let output_ok = crate::api::reader::clear_reader_page_cache_frb(api_comic_id)?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__library__get_current_library_id_frb_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, crate::api::init::HentaiErrorDto>((move || {
                let output_ok = crate::api::library::get_current_library_id_frb()?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__library__list_libraries_frb_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, crate::api::init::HentaiErrorDto>((move || {
                let output_ok = crate::api::library::list_libraries_frb()?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__named_facet__list_named_facet_for_form_frb_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, crate::api::init::HentaiErrorDto>((move || {
                let output_ok = crate::api::named_facet::list_named_facet_for_form_frb(api_facet)?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__library__set_current_library_id_frb_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, crate::api::init::HentaiErrorDto>((move || {
                let output_ok = crate::api::library::set_current_library_id_frb(api_library_id)?;
                Ok(output_ok)
            })())
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        24 => wire__crate__api__thumbnail__ensure_thumbnail_by_comic_id_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        29 => wire__crate__api__series__fetch_series_comics_page_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        34 => wire__crate__api__thumbnail__find_series_thumbnail_by_series_id_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        35 => wire__crate__api__thumbnail__find_thumbnail_by_comic_id_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        60 => wire__crate__api__reader__prefetch_reader_pages_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        62 => wire__crate__api__comic__refresh_comic_metadata_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        63 => wire__crate__api__series__refresh_library_metadata_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        64 => wire__crate__api__series__refresh_series_metadata_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        68 => wire__crate__api__thumbnail__resolve_series_cover_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        70 => wire__crate__api__comic__search_by_keyword_page_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        71 => wire__crate__api__comic__search_by_tag_expression_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        72 => wire__crate__api__comic__search_by_tag_expression_page_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        73 => wire__crate__api__series__search_series_by_keyword_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        74 => wire__crate__api__series__search_series_by_tag_expression_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        75 => wire__crate__api__series__series_comics_metadata_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        76 => wire__crate__api__series__series_meta_locks_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        77 => wire__crate__api__series__series_sort_field_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        78 => wire__crate__api__series__series_sort_option_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        81 => wire__crate__api__comic__set_comic_meta_locks_frb_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        88 => wire__crate__api__series__set_series_meta_locks_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        91 => wire__crate__api__sync__sync_library_frb_impl(port, ptr, rust_vec_len, data_len),
        93 => wire__crate__api__comic__update_comic_user_meta_frb_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        100 => wire__crate__api__series__update_series_user_meta_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        108 => wire__crate__api__path__watch_paths_frb_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        6 => {
            wire__crate__api__reader__clear_reader_page_cache_frb_impl(ptr, rust_vec_len, data_len)
        }
        ...
        20 => wire__crate__api__history__delete_reading_by_comic_id_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__history__delete_reading_by_comic_ids_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__tag__delete_tags_by_names_frb_impl(ptr, rust_vec_len, data_len),
        23 => wire__crate__api__thumbnail__delete_thumbnails_by_comic_ids_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        28 => wire__crate__api__series__fetch_series_comics_metadata_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        38 => {
            wire__crate__api__library__get_current_library_id_frb_impl(ptr, rust_vec_len, data_len)
        }
        ...
        41 => wire__crate__api__series__get_series_reading_context_by_comic_id_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        51 => wire__crate__api__character__list_distinct_characters_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        54 => wire__crate__api__named_facet__list_named_facet_for_form_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        55 => wire__crate__api__series__load_home_series_comic_order_map_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        79 => wire__crate__api__library__set_all_libraries_scan_on_startup_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        80 => wire__crate__api__comic__set_comic_meta_locks_frb_impl(ptr, rust_vec_len, data_len),
        82 => wire__crate__api__thumbnail__set_comic_thumbnail_from_page_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        85 => wire__crate__api__sync__set_remote_library_credentials_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        86 => wire__crate__api__series__set_series_item_sort_order_locked_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        89 => wire__crate__api__series__set_series_meta_locks_frb_impl(ptr, rust_vec_len, data_len),
        90 => wire__crate__api__thumbnail__set_series_thumbnail_from_page_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        92 => wire__crate__api__comic__update_comic_user_meta_frb_impl(ptr, rust_vec_len, data_len),
        94 => wire__crate__api__library__update_library_format_groups_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        96 => wire__crate__api__library__update_library_sidebar_layout_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        97 => wire__crate__api__library__update_local_library_root_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        99 => wire__crate__api__series__update_series_item_sort_order_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
