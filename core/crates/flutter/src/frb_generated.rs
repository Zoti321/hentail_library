...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1660756359;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        44 => wire__crate__api__history__get_reading_by_comic_id_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        64 => wire__crate__api__reader__prefetch_reader_pages_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        66 => wire__crate__api__comic__refresh_comic_metadata_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        67 => wire__crate__api__series__refresh_library_metadata_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        68 => wire__crate__api__series__refresh_series_metadata_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        72 => wire__crate__api__thumbnail__resolve_series_cover_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        74 => wire__crate__api__comic__search_by_keyword_page_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        75 => wire__crate__api__comic__search_by_tag_expression_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        76 => wire__crate__api__comic__search_by_tag_expression_page_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        77 => wire__crate__api__series__search_series_by_keyword_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        78 => wire__crate__api__series__search_series_by_tag_expression_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        79 => wire__crate__api__series__series_comics_metadata_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        80 => wire__crate__api__series__series_meta_locks_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        81 => wire__crate__api__series__series_sort_field_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        82 => wire__crate__api__series__series_sort_option_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        85 => wire__crate__api__comic__set_comic_meta_locks_frb_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        87 => wire__crate__api__library__set_current_library_id_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        91 => wire__crate__api__series__set_series_meta_locks_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        94 => wire__crate__api__sync__sync_library_frb_impl(port, ptr, rust_vec_len, data_len),
        96 => wire__crate__api__comic__update_comic_user_meta_frb_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        103 => wire__crate__api__series__update_series_user_meta_dto_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        105 => wire__crate__api__author__watch_authors_frb_impl(port, ptr, rust_vec_len, data_len),
        106 => wire__crate__api__comic__watch_comic_changes_impl(port, ptr, rust_vec_len, data_len),
        107 => wire__crate__api__home__watch_continue_reading_top5_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        108 => wire__crate__api__home__watch_home_page_counts_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        109 => wire__crate__api__series__watch_home_series_comic_order_map_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        110 => wire__crate__api__history__watch_reading_histories_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        111 => wire__crate__api__tag__watch_tags_frb_impl(port, ptr, rust_vec_len, data_len),
        112 => wire__crate__api__thumbnail__watch_thumbnail_events_frb_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        65 => wire__crate__api__history__record_reading_frb_impl(ptr, rust_vec_len, data_len),
        69 => wire__crate__api__author__rename_author_frb_impl(ptr, rust_vec_len, data_len),
        70 => wire__crate__api__named_facet__rename_named_facet_name_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        71 => wire__crate__api__tag__rename_tag_frb_impl(ptr, rust_vec_len, data_len),
        83 => wire__crate__api__library__set_all_libraries_scan_on_startup_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        84 => wire__crate__api__comic__set_comic_meta_locks_frb_impl(ptr, rust_vec_len, data_len),
        86 => wire__crate__api__thumbnail__set_comic_thumbnail_from_page_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        89 => wire__crate__api__sync__set_remote_library_credentials_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        90 => wire__crate__api__series__set_series_item_sort_order_locked_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        92 => wire__crate__api__series__set_series_meta_locks_frb_impl(ptr, rust_vec_len, data_len),
        93 => wire__crate__api__thumbnail__set_series_thumbnail_from_page_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        95 => wire__crate__api__comic__update_comic_user_meta_frb_impl(ptr, rust_vec_len, data_len),
        97 => wire__crate__api__library__update_library_format_groups_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        99 => wire__crate__api__library__update_library_sidebar_layout_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        100 => wire__crate__api__library__update_local_library_root_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        102 => wire__crate__api__series__update_series_item_sort_order_frb_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
